...
class GBDT:
    ...
    def train_model(self):
        ...
        gridSearchModel = GridSearchCV(GradientBoostingClassifier(), self.params, cv=self.cv, n_jobs=-1)
    ...
    def test_model(self):
        ...
        # predict labels
        gbdt = GradientBoostingClassifier(**self.model.best_params_).fit(X_all, y_all)
        predicted = gbdt.predict(test_features[best_features])
