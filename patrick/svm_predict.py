...
class SVM:
    ...
    def train_model(self):
        ...
        gridSearchModel = GridSearchCV(SVC(), self.params, cv=self.cv, n_jobs=-1)
    ...
    def test_model(self):
        ...
        # predict labels
        svm = SVC(**self.model.best_params_).fit(X_all, y_all)
        predicted = svm.predict(test_features[best_features])
